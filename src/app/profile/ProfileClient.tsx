...
export function ProfileClient({ player }: ProfileClientProps) {
  return (
    <div className="container py-6 px-2 max-w-lg mx-auto">
      <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center text-[#FFD700] drop-shadow-[2px_2px_0px_rgba(0,0,0,0.5)]">
        Profil
      </h1>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="pixel-card p-4 flex flex-col items-center">
                <p className="text-xs md:text-sm font-medium text-[#FFD700]">EXP</p>
                <p className="text-xl md:text-2xl text-[#D4B886]">{player.exp}</p>
              </div>
              <div className="pixel-card p-4 flex flex-col items-center">
                <p className="text-xs md:text-sm font-medium text-[#87CEEB]">Mana</p>
                ...
                <p className="text-base md:text-lg text-[#87CEEB] mt-1">{player.mana}/100</p>
              </div>
              <div className="pixel-card p-4 flex flex-col items-center">
                <p className="text-xs md:text-sm font-medium text-[#FF6B6B]">HP</p>
                <div className="relative w-full h-4 mt-2 pixel-progress">
                  <div 
                ...
                <p className="text-base md:text-lg text-[#FF6B6B] mt-1">{player.hp}/100</p>
              </div>
            </div>
          </CardContent>
        </Card>
